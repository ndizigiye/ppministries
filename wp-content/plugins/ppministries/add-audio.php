...
class AddAudio{
	...
	function add_form(){
		$form='
<div class="wrap">
<div id="icon-options-general" class="icon32"><br></div><h2>Add new Audio</h2>

<form method="post" action="?page=ppministries-audios&action=save">
<table class="form-table">
<tbody>
<tr valign="top">
<th scope="row"><label for="title">Source</label></th>
<td><input name="source" type="text" id="source" value="" class="regular-text"></td>
</tr>
<tr valign="top">
...
<p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary" value="Save Changes"></p></form>
	...
	function edit_form($id){
		global $wpdb;
		$data = $wpdb->get_results('SELECT * FROM wp_audios WHERE ID='.$id);
		//die(var_dump($data));
                $form='
<div class="wrap">
<div id="icon-options-general" class="icon32"><br></div><h2>Edit audio</h2>
<form method="post" action="?page=ppministries-audios&action=save">
<table class="form-table">
<tbody>
<tr valign="top">
...
<tr valign="top">
<th scope="row"><label for="title">Source</label></th>
<td><input name="source" type="text" id="source" value="'.$data[0]->Source.'" class="regular-text"></td>
</tr>
<tr valign="top">
<th scope="row"><label for="tags">Tags</label></th>
