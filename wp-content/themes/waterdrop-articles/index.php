...
<link href="lib/menucool/themes/1/js-image-slider.css" rel="stylesheet"
	type="text/css" />
<script src="lib/menucool/themes/1/js-image-slider.js"
...
<link href="<?php bloginfo('template_url') ?>/css/default.css" rel="stylesheet" type="text/css"
	media="all" />
<link href="<?php bloginfo('template_url') ?>/css/read.css" rel="stylesheet" type="text/css" media="all" />
<!--[if IE 6]>
...
<?php wp_nav_menu(array('theme_location' => 'main_nav', 'container' => '')); ?>
		...
		<div id="articles-two-columns">
			<div id="article">
				<h2>How to Glorify God at work</h2>
				<div id="main-image">
				...
				<div id="summary">
					<div id="author">
						...
						<p id="author-name">By Author Name</p>
						<p id="article-date">1 month ago</p>
					</div>
					<div id="summary-text">Lorem ipsum dolor sit amet,
						...
						venenatis vitae, justo. Nullam dictum felis eu pede mollis pretius
					</div>
				</div>
				<div id="main-text">
					...
					<p>Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget,
						...
						orci. Nunc nec neque. Phasellus leo dolor empus non, auctor et,
			...
			<div id="related-articles">
				...
				<div id="article-entry">
					...
					<p id="article-entry-article-name">
						<a href="#">How to Glorify God at Work.</a>
					</p>
					<p id="article-entry-author-name">By Author Name</p>
				</div>
				<div id="article-entry">
					<img src="images/earth_1.jpg" />
					<p id="article-entry-article-name">
						<a href="#">How to Glorify God at Work.</a>
					</p>
					<p id="article-entry-author-name">By Author Name</p>
